...
export const allArticles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { text: "Não podemos esquecer dos goleiros. Alisson Becker, do Brasil, e Thibaut Courtois, da Bélgica, são considerados dois dos melhores do mundo e podem ser decisivos em fases eliminatórias, onde um penalti defendido ou uma defesa milagrosa separam a glória da eliminação. Na Copa, a solidez defensiva costuma ser tão importante quanto o poder de ataque." },
      { text: "A Copa de 2026 será histórica não apenas pelo formato expandido, mas pela qualidade dos jogadores em campo. Uma nova geração de craques está pronta para escrever seus nomes na história do futebol mundial. Quem será o grande herói desta vez? Só o tempo dirá — mas enquanto isso, que tal descobrir qual desses jogadores mais combina com você?" },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      { text: "Mito: comer manga com leite faz mal. Essa é uma lenda urbana tipicamente brasileira com raízes históricas. Durante o período da escravidão no Brasil, os senhores de engenho inventaram essa história para que os escravizados não consumissem o leite que era considerado um produto caro. A manga era abundante e acessível, então a combinação foi demonizada para proteger o estoque de leite. Na realidade, a mistura é perfeitamente segura e até nutritiva — pense em vitaminas e smoothies de manga." },
      { text: "Verdade: o estresse pode causar cabelos brancos. Por muito tempo, essa crença foi considerada um mito, mas pesquisadores da Universidade de Harvard demonstraram em 2020 que o estresse ativa o sistema nervoso simpático e destrói as células-tronco responsáveis pela pigmentação dos fios de cabelo. O estudo mostrou que, uma vez que essas células são perdidas, o dano é permanente. Então sim, situações de estresse intenso podem literalmente embranquecer seus cabelos." },
      { text: "Mito: tomar café atrofia o crescimento. Essa crença se popularizou principalmente entre pais preocupados com seus filhos. Não existe nenhuma evidência científica de que a cafeína afete o crescimento. A altura é determinada principalmente pela genética e pela nutrição adequada durante a infância e adolescência. O café pode causar insônia e irritabilidade em crianças devido à sensibilidade à cafeína, mas não interfere no crescimento ósseo." },
      { text: "A lição mais importante é sempre buscar informações baseadas em evidências científicas, em vez de aceitar crenças populares sem questionamento. A ciência evolui constantemente, e o que achávamos verdade ontem pode ser desmentido amanhã. Se você gostou de separar fatos de ficção, temos um quiz completo sobre mitos de saúde que vai testar todo o seu conhecimento!" },
    ],
  },
  {
    ...
    content: [
      ...
      { text: "As redes sociais amplificaram exponencialmente o apelo dos quizzes. Compartilhar um resultado é uma forma de expressão social: ao postar 'Eu sou 87% nerd', você está comunicando algo sobre sua identidade para seus amigos. Isso ativa circuitos de conexão social no cérebro, pois gera comentários, comparações e conversas. Pesquisas da Universidade de Nova York mostraram que conteúdos que envolvem autorrevelação ativam as mesmas áreas cerebrais associadas à comida e ao dinheiro." },
      { text: "Existe também o fator competição. Quizzes de trivia frequentemente mostram sua pontuação ou comparam você com outros jogadores, ativando nosso instinto competitivo natural. Estudos em psicologia evolucionária sugerem que a competição por conhecimento era uma forma de ganhar status social em grupos humanos primitivos. Quem sabia mais sobre o ambiente, os animais e as plantas tinha mais chances de sobreviver e ser respeitado pelo grupo." },
      { text: "A gamificação — o uso de elementos de jogos em contextos não lúdicos — explica por que quizzes são mais envolventes que simplesmente ler um texto informativo. Elementos como pontuação, vidas limitadas, timer e ranking transformam o aprendizado passivo em uma experiência ativa e emocional. Quando você tem apenas 3 vidas e erra uma pergunta, a tensão aumenta, o coração acelera e a atenção se aguça. É entretenimento e aprendizado ao mesmo tempo." },
      { text: "No fim das contas, os quizzes funcionam porque combinam vários dos maiores motivadores humanos: curiosidade, autoconhecimento, competição, conexão social e a busca por prazer. Não é à toa que bilhões de quizzes são feitos todos os anos ao redor do mundo. E agora que você entende a ciência, que tal colocar seu cérebro para trabalhar e testar seus conhecimentos?" },
    ],
  },
];
