...
export const qualArtilheiroHistorico: Quiz = {
  ...
  introText: "O gol é o momento mais democrático do futebol — qualquer pessoa, em qualquer lugar do campo, pode marcar. Mas os grandes artilheiros da história transformaram esse momento em arte pessoal, com estilos tão distintos que você reconhece o autor antes de ver o número na camisa.\n\nPelé jogava como se o campo fosse pequeno demais para ele. Em 1.363 jogos oficiais, marcou 1.281 gols — uma média que nenhum jogador da era moderna conseguiu replicar. Romário, por sua vez, era o oposto do espetáculo: resolvia tudo na pequena área, com um toque, sem firula, e desaparecia pelo resto do jogo até ser necessário de novo. Ronaldo Fenômeno combinava velocidade, força e técnica de uma forma que médicos e treinadores ainda consideram única na história do esporte.\n\nE Marta — seis vezes eleita a melhor jogadora do mundo pela FIFA — fez mais do que marcar gols. Ela abriu caminho em um esporte que oferecia às mulheres salários mínimos, estádios vazios e zero cobertura de televisão, e transformou o futebol feminino brasileiro em algo que o país finalmente começou a levar a sério.\n\nNeste quiz de personalidade, 10 perguntas sobre como você lida com pressão, trabalho em equipe, competição e reconhecimento revelam qual desses estilos de gol mais combina com o seu. Os perfis incluem estatísticas reais de carreira e contexto histórico, com dados da FIFA.",
  profiles: [
    {
      id: "pele",
