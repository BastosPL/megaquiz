...
export const casaDePapelPersonagem: Quiz = {
  ...
  introText: "La Casa de Papel não virou a série não anglófona mais assistida da Netflix por acidente. Parte do fascínio está nos personagens — e no fato de que cada um deles representa um estilo completamente diferente de lidar com pressão, autoridade e lealdade.\n\nO Professor criou o plano inteiro a partir de uma planilha e um quadro branco. Tokyo entrava atirando e depois improvisava uma saída. Berlin tratava cada momento como se fosse sua última cena num palco. Nairobi transformava caos em produção industrial. E Denver — bom, Denver seguia o coração, mesmo quando o coração o levava para a pior decisão possível.\n\nO que torna esses personagens memoráveis não é só o que fazem durante os assaltos — é o que revelam sobre tipos reais de comportamento humano. A série escrita por Álex Pina explora dinâmicas de grupo, liderança sob estresse, dilemas morais e o limite entre idealismo e sobrevivência, tudo dentro de uma trama que não deixa você parar de assistir.\n\nNeste quiz de personalidade, você responde 10 perguntas sobre como reagiria em situações de pressão, trabalho em equipe e tomada de decisão. No final, descobre qual dos cinco personagens mais se aproxima do seu perfil — com uma análise que vai além do óbvio e conecta traços de personalidade a momentos específicos da série.",
  profiles: [
    {
      id: "professor",
