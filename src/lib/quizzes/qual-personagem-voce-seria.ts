...
export const qualPersonagemVoceSeria: Quiz = {
  ...
  introText: "As séries que marcaram a última década criaram personagens tão distintos que viraram referência de personalidade na cultura pop. Dizer que alguém 'é um Tommy Shelby' ou 'tem energia de Wednesday' já comunica mais sobre uma pessoa do que qualquer descrição longa — porque esses personagens carregam camadas de comportamento, motivação e contradição que o público absorveu ao longo de dezenas de episódios.\n\nO Professor, de La Casa de Papel, resolve problemas como um engenheiro emocional — cada variável prevista, cada reação humana mapeada. Eleven, de Stranger Things, enfrenta o desconhecido de peito aberto, mesmo quando o custo pessoal é altíssimo. Tommy Shelby, de Peaky Blinders, opera na zona cinzenta entre estratégia e brutalidade, com um pragmatismo que incomoda e fascina ao mesmo tempo. E Wednesday Addams transformou o isolamento social numa ferramenta de poder, com uma inteligência afiada que não pede desculpas.\n\nCada um desses personagens representa um modo diferente de enfrentar conflito, construir relações e tomar decisões sob pressão. Este quiz de personalidade usa 10 perguntas sobre situações cotidianas — trabalho, amizades, crises, preferências — para mapear qual desses perfis mais se aproxima do seu jeito de funcionar. O resultado inclui análise de traços específicos, referências a cenas das séries e contexto cultural sobre por que aquele personagem ressoa com tanta gente.",
  profiles: [
    {
      id: "professor",
