...
export const verdadeOuMitoSaude: Quiz = {
  ...
  introText: "Existe um tipo de conselho médico que sobrevive a gerações inteiras sem nunca ser verificado. 'Não nade depois de comer', 'ler no escuro estraga a visão', 'estalar os dedos causa artrite' — frases que você provavelmente ouviu da sua avó, que ouviu da avó dela, e que ninguém parou para checar numa fonte científica de verdade.\n\nAlgumas dessas crenças têm um fundo de verdade surpreendente. Outras foram desmentidas décadas atrás por estudos publicados em revistas como The Lancet e JAMA, mas continuam circulando porque soam plausíveis e porque repetição cria familiaridade — e familiaridade, para o cérebro humano, se parece muito com verdade. Em psicologia, isso tem nome: é o efeito de ilusão de verdade, documentado por Hasher, Goldstein e Toppino em 1977.\n\nEste quiz reúne 15 afirmações sobre saúde que você provavelmente já repetiu ou ouviu alguém repetir. O formato é direto — Verdade ou Mito — e cada resposta vem acompanhada de uma explicação com base em fontes como a Organização Mundial da Saúde e a National Library of Medicine (PubMed). O objetivo não é substituir um médico, mas treinar o olhar crítico para o tipo de informação de saúde que circula no WhatsApp, no almoço de domingo e nos reels do Instagram.\n\nVocê começa com 3 vidas. A cada erro, perde uma. Se zerar, é game over — e talvez um bom motivo para repensar alguns hábitos de informação.",
