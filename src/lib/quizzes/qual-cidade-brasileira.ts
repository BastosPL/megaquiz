...
export const qualCidadeBrasileira: Quiz = {
  ...
  introText: "O Brasil tem 5.570 municípios espalhados por 8,5 milhões de km² — e cada região oferece um estilo de vida radicalmente diferente. Dados do IBGE mostram que variáveis como custo de vida, clima, oferta cultural e oportunidades de trabalho variam tanto entre capitais brasileiras que mudar de cidade pode ser quase como mudar de país.\n\nSão Paulo é a maior metrópole do hemisfério sul, com 12 milhões de habitantes, mais de 12 mil restaurantes e uma vida noturna que não para — mas também com trânsito de 3 horas e custo de aluguel que consome 40% do salário médio. O Rio de Janeiro combina praia, montanha e cultura numa geografia que não existe em nenhum outro lugar do planeta — mas enfrenta desafios de segurança que moldam a rotina de quem vive lá. Florianópolis foi eleita repetidamente uma das melhores cidades para se viver no Brasil por índices de qualidade de vida, educação e segurança. E Recife, capital do Nordeste, oferece um dos cenários culturais mais ricos do país — do frevo ao manguebeat — com custo de vida significativamente menor que o eixo Sul-Sudeste.\n\nEste quiz de personalidade usa 10 perguntas sobre estilo de vida, prioridades, rotina e valores para descobrir qual cidade brasileira mais combina com o seu perfil. Os resultados trazem dados reais do IBGE sobre cada cidade, conectando suas preferências a características concretas do lugar.",
  profiles: [
    {
      id: "rio",
