...
export const qualVilaoDeSerie: Quiz = {
  ...
  introText: "Os vilões mais lembrados da televisão não são os mais cruéis — são os mais coerentes. Walter White não acordou um dia e decidiu ser mau. Ele seguiu uma lógica interna que, passo a passo, transformou um professor de química em um dos narcotraficantes mais perigosos do Novo México. Cada decisão fazia sentido dentro do universo moral que ele mesmo construiu — e é exatamente por isso que Breaking Bad funciona.\n\nO mesmo vale para Cersei Lannister, que queimou o Septo de Baelor com fogo valisiano não por maldade gratuita, mas porque calculou que era a única jogada que restava. Ou para o Coringa de Heath Ledger, que não queria dinheiro nem poder — queria provar uma tese filosófica sobre a natureza humana e estava disposto a explodir um hospital para testar a hipótese.\n\nO que conecta esses personagens é que cada um representa uma forma diferente de responder à mesma pergunta: o que você faz quando as regras do jogo não funcionam a seu favor? Alguns reescrevem as regras. Outros eliminam o jogo inteiro.\n\nNeste quiz de personalidade, 10 perguntas sobre como você lida com poder, justiça, lealdade e ambição revelam qual vilão icônico compartilha a sua lógica — com perfis que analisam motivações, referências a cenas específicas e o contexto psicológico por trás de cada antagonista.",
  profiles: [
    {
      id: "walter",
