...
export const golsHistoricosCopa: Quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { id: "a", text: "Gol da Arabia Saudita contra Argentina", isCorrect: false },
        { id: "b", text: "Gol de Gakpo (Holanda) contra Equador", isCorrect: false },
        { id: "c", text: "Gol de Al-Dawsari (Arabia) contra Argentina", isCorrect: true },
        { id: "d", text: "Gol de Richarlison (Brasil) contra Serbia", isCorrect: false },
      ],
    },
    {
      id: "q10",
      text: "Qual foi o gol mais bonito da Copa 2022 (premio Puskas)?",
      options: [
      ...
      explanation: "A bicicleta de Richarlison contra a Serbia foi eleita o gol mais bonito da Copa 2022!",
    },
    {
      id: "q11",
