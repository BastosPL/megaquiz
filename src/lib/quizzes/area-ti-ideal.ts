...
export const areaTiIdeal: Quiz = {
  ...
  introText: "O mercado de tecnologia brasileiro tem uma das maiores lacunas de talentos do mundo: segundo a Brasscom, o país vai precisar de 797 mil novos profissionais de TI até 2025, mas forma apenas 53 mil por ano. Isso significa que praticamente qualquer pessoa com as habilidades certas encontra trabalho — a questão é descobrir qual área combina com o seu perfil.\n\nE as áreas são mais diferentes do que parecem. Desenvolvimento front-end é sobre criar interfaces que pessoas reais vão usar — requer senso estético, empatia com o usuário e domínio de ferramentas como React, CSS e acessibilidade. Back-end é sobre a lógica invisível que faz tudo funcionar — bancos de dados, APIs, escalabilidade, segurança. Ciência de dados transforma números brutos em decisões de negócio usando estatística, Python e machine learning. Cybersegurança protege sistemas contra ameaças que evoluem diariamente. E inteligência artificial — o campo mais quente do momento — combina matemática pesada com criatividade algorítmica.\n\nCada uma dessas áreas atrai perfis comportamentais diferentes. Quem gosta de resultado visual tende ao front-end. Quem prefere resolver puzzles lógicos tende ao back-end. Quem é curioso sobre padrões se dá bem com dados.\n\nEste quiz de personalidade usa 10 perguntas sobre como você pensa, resolve problemas e se motiva para sugerir qual especialização de TI mais combina com você. Os resultados incluem ferramentas relevantes e faixas salariais estimadas do mercado brasileiro, com base no Guia Salarial Robert Half 2026.",
